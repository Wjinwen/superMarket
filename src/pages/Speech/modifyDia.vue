<template>
  <t-dialog
    :destroyOnClose="true" :header="`${opType === 'add' ? '编辑' : '新增'}反应语言`" v-model:visible="visible" width="500px"
  ...
  >
    <t-form ref="form" :label-width="0" :rules="rules" :data="data">
      <t-form-item name="ques">
        <t-textarea placeholder="请输入反应语言" />
      </t-form-item>
    </t-form>
  </t-dialog>
</template>
...
const rules: FormProps['rules'] = {
  ques: [{required: true,message: '请输入反应语言',type: 'error',trigger: 'blur',}],
}
